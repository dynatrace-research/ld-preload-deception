...
/**
 * Defines the interval time for honeBookThread in seconds.
 *
 */
#define HONEYAML_CHECK_INTERVAL 5

/**
 * Thread that periodically checks for update of a HoneYamlFile and updates the global
 */
